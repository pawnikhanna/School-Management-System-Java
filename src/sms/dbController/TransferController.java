...
public class TransferController {
    ...
    public static int transferStudent(ArrayList<Student> student) throws ClassNotFoundException, SQLException {
        ...
        // paststudents(adNo,fullName,name,dob,doa,gender,year,parentName,nic,phone,)";
    ...
    public static int updateGrade(String year) throws ClassNotFoundException, SQLException {
        String sql = "UPDATE paststudents SET year= '" + year + "'  WHERE year= 'Spring 2025'";
        Connection conn = DBConnection.getDBConnection().getConnection();
        PreparedStatement stm = conn.prepareStatement(sql);
    ...
    public static ArrayList<Student> getGrade5() throws ClassNotFoundException, SQLException {
        ...
        ResultSet rst = stm.executeQuery("Select * From students Where grade = 'Spring 2025'");
        ArrayList<Student> studentList = new ArrayList<>();
        while (rst.next()) {
            Student student = new Student(rst.getInt(1), rst.getString(2), rst.getString(3), rst.getString(4),
